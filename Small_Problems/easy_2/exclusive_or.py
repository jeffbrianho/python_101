...
# a falsy value if both operands are falsy. The and operator returns a truthy value 
# if both of its operands are truthy, and a falsy value if either operand is falsy. 
...
# In this exercise, you will write an xor function that takes two arguments, and returns
